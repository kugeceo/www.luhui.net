...
searchSelect = {
  'wangye': {
    0 : '搜网页',
    'zhineng': ['http://www.luhui.net:90/', '鲁虺智能'],
    'baidu': ['http://www.luhui.net:90/spider.php?Category=web&q=', '百度'],
    'qihu360': ['https://www.so.com/s?src=lm&ls=s7348d2dc7f&q=', '奇虎360'],
    'zhida': ['http://search.luhui.net:90/template.php?q=', '直达'],
    'sougou': ['http://www.sogou.com/web?ie=utf8&query=', '搜狗'],
    'shenma': ['http://dir.2mfa.cn:90/', '摩发网'],
    'UCshenma': ['http://soma.sma.so/?q=', 'UC神马'],
    'zhannei': ['member.php?get=search_site&q=', '站内'],
    'Google': ['http://www.google.com.hk/search?hl=zh-CN&q=', 'Google']
  },
  'taobao': {
    0 : '搜淘宝',
    'taobao': ['https://s.taobao.com/search?unid=&pid=mm_31320626_3466227_58448586&search_type=auction&commend=all&at_topsearch=1&user_action=initiative&spercent=0&f=D9_5_1&ie=utf-8&q=', '淘宝'],
    'zhuoyue': ['http://www.amazon.cn/s/?ie=utf-8&keywords=', '卓越']
  },
  'tupian': {
    0 : '搜图片',
    'baidu': ['http://image.baidu.com/search/index?tn=baiduimage&word=', '百度'],
    '360tupian': ['http://image.so.com/i?ie=utf-8&src=sma.so&q=', '360图片'],
    'nituwang': ['http://soso.nipic.com/?q=', '昵图网'],
    'Google': ['http://images.google.com.hk/images?hl=zh-CN&q=', 'Google']
  },
  'yingyin': {
    0 : '搜影音',
    'youku': ['http://www.soku.com/search_video/q_', '优酷'],
    'aiqiyi': ['http://so.iqiyi.com/so/q_', '爱奇艺'],
    'leshi': ['http://so.le.com/s?wd=', '乐视'],
    'tengxun': ['http://v.qq.com/x/search/?q=', '腾讯'],
    'baidushipin': ['http://video.baidu.com/v?ie=utf-8&word=', '百度视频'],
    'baiduyinle': ['http://music.baidu.com/search?ie=utf-8&key=', '百度音乐'],
    'sougouyinle': ['http://mp3.sogou.com/music.so?query=', '搜狗音乐'],
    'QQyinle': ['http://y.qq.com/portal/search.html#searchid=1&remoteplace=txt.yqq.top&t=song&w=', 'QQ音乐'],
  ...
  'ditu': {
    0 : '搜地图',
    'baiduditu': ['http://ditu.baidu.com/?s=s%26wd%3D', '百度地图'],
    '360ditu': ['http://ditu.so.com/?ie=utf-8&src=sma.so&t=map&k=', '360地图'],
    'tengxunditu': ['http://map.qq.com/?what=', '腾讯地图'],
    'gaodeditu': ['http://ditu.amap.com/search?query=', '高德地图'],
    'sougouditu': ['http://map.sogou.com/#lq=', '搜狗地图'],
    'Google': ['http://ditu.google.cn/maps?hl=zh-CN&q=', 'Google']
  },
  'qiye': {
    0 : '搜企业',
    'qiyexinxi': ['http://xin.baidu.com/s?q=', '企业信息'],
    'fanyi': ['http://fanyi.baidu.com/#en/zh/', '翻译'],
    'zhida': ['http://search.luhui.net:90/template.php?q=', '直达']
  }
};
/* /search_bar */
...
#logo { }\
#search { }\
#search_body { width:550px; height:68px; font-size:14px; text-align:center; }\
#search_bar { width:550px; height:30px; position:relative; clear:both; z-index:2; }\
#search_bar_in { width:550px; overflow:hidden; }\
#search_bar_in a { width:49px; height:29px; padding:1px 0 0 1px; line-height:30px; display:inline-block !important; display:inline; zoom:1; text-align:center; overflow:hidden; position:relative; }\
#search_bar_in a span { width:50px; height:30px; position:absolute; top:0; left:0; text-align:center; cursor:pointer; }\
#search_bar_in a:hover { background:none; }\
#search_bar_in a#searchNavIs { width:55px; font-size:14px; font-weight:bold; cursor:default; }\
#search_bar_in a#searchNavIs { /*background-position:-480px -5px;*/ background:none; }\
#search_bar_in a#searchNavIs span { width:56px; color:#666666; text-decoration:none; }\
#f { width:550px; height:38px; background-position:0 0; position:relative; z-index:1; }\
#ou { width:81px; height:36px; margin:1px; float:left; text-align:left; cursor:pointer; position:relative; z-index:6; }\
.ou_in { width:81px; height:36px; text-align:center; overflow:hidden; position:absolute; left:0; top:0; z-index:61; }\
...
.ou_in img { margin:3px 0; }\
#kw { width:380px; height:30px; line-height:30px; padding:3px; margin:1px 0 1px -1px; }\
#su { width:81px; height:30px; margin:4px 0 0 0; font-size:14px; }\
#search_hot_word { min-height:30px; padding-top:7px; padding-bottom:7px; font-size:12px; line-height:150%; }\
#search_hot_word a { margin:0 3px; }\
#changebar { background:url(c_bar_1.gif) 0 0 no-repeat; width:15px; height:15px; overflow:hidden; position:absolute; top:21px; right:2px; z-index:20;filter:progid:DXImageTransform.Microsoft.Alpha(opacity=70); -moz-opacity:0.7; -khtml-opacity:0.7; opacity:0.7; }\
...
document.writeln('<style type="text/css">\
#search { }\
#search_body { width:509px; height:38px; font-size:14px; position:relative; z-index:3; margin-left:0; }\
#f { width:509px; height:38px; background-position:0 -42px; position:relative; }\
#kw { width:396px; height:30px; line-height:30px; margin:4px 0 0 4px; padding-left:3px; padding-right:3px; }\
#su { width:69px; height:30px; margin:4px 0 0 0; font-size:14px; color:#FFFFFF; }\
#search_bar_next { position:relative; z-index:4; float:left; margin-top:7px; width:26px; }\
.ou_in_ { position:absolute; top:0; left:0; z-index:69; margin:0; width:26px; height:24px; overflow:hidden; border:none; background:none; }\
...
#logo { }\
#search { }\
#search_body { width:610px; height:94px; font-size:18px; text-align:left; margin-left:0; }\
#search_bar { margin-left:0; width:450px; height:28px; position:relative; z-index:2; }\
#search_bar_in { width:650px; height:30px; font-size:14px; position:absolute; left:0; top:0; z-index:15; overflow:hidden; }\
#search_bar_in a { width:49px; float:left; padding:1px 0 0 1px; height:29px; line-height:28px; text-align:center; overflow:hidden; position:relative; }\
#search_bar_in a span { width:50px; height:28px; position:absolute; top:0; left:0; text-align:center; cursor:pointer; }\
#search_bar_in a:hover { background-position: right top; }\
#search_bar_in a#searchNavIs { background-position:-622px 0; }\
#search_bar_in a#searchNavIs { width:55px; font-size:14px; font-weight:bold; cursor:default; }\
#search_bar_in a#searchNavIs span { width:56px; color:#666666; }\
#f { margin-left:0; width:610px; height:50px; float:left; background-position:0 -83px; position:relative; z-index:1; }\
#ou { height:28px; margin-top:38px; line-height:28px; }\
#ou_in { padding:5px 0; text-align:left; width:650px; white-space:nowrap; overflow:hidden; }\
#ou_in button { margin-left:10px; margin-right:10px; padding:0; background:none; border:none; height:28px; line-height:20px; font-weight:normal; letter-spacing:0; cursor:pointer; }\
#ou_in button#ou_in_is { color:#999; background:#4BA634; padding-left:10px; padding-right:10px; font-weight:bold; }\
.ou_out {}.ou_in img {}\
#kw { height:45px; line-height:38px; width:493px; margin:5px 0 0 5px; }\
#su { height:38px; margin:8px 0 0 0; width:110px; font-size:18px; color:#FFFFFF; }\
#search_hot_word { line-height:150%; white-space:normal; }\
#search_hot_word a { margin:0 3px; font-size:14px; text-decoration:underline; }\
#changebar { background:url(c_bar_3.gif) 0 0 no-repeat; width:15px; height:15px; overflow:hidden; position:absolute; top:30px; right:5px; z-index:20;filter:progid:DXImageTransform.Microsoft.Alpha(opacity=70); -moz-opacity:0.7; -khtml-opacity:0.7; opacity:0.7; }\
</style><table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td><div id="search_body" class="forQQ3"><div id="search_bar"><div id="search_bar_in">');if(isArray(searchSelect)){for(type in searchSelect){var searchBarName=searchSelect[type][0].toString().replace(/搜/g,'');document.writeln('<a id="search_bar_type_'+type+'" name="search_bar_type_'+type+'" href="javascript:void(0);" onclick="addsearchBar(\''+type+'\');return false;" hidefocus="true">'+searchBarName+'<span>'+searchBarName+'</span></a>');delete searchBarName}}document.write('</div></div><form id="f" name="f" onsubmit="return remenber()"><input type="text" name="q" id="kw" id="query" maxlength="100" x-webkit-speech /><button name="su" type="submit" id="su">搜网页</button><div id="ou"><div id="ou_in"></div></div><input name="go" id="go" type="hidden" /><a href="javascript:void(0);" id="changebar" title="切换引擎模式" onclick="changeBar();return false;"></a></form></div></td><td id="search_hot_word" class="forQQ_3"></td></tr></table>');function getSearchSelect3(type,n){var strOther='<input name="is" id="is" type="hidden" value="'+type+'">';for(i in searchSelect[type]){if(i!=0){var thisChecked=i==n?' id="ou_in_is" disabled="disabled"':'';
