...
setTimeout(function () {
	...
	PKAudioEditor._deps.Wlc = function () {
			...
			if (PKAE.isMobile) {
				...
				// body_str2 = 'Check out the codebase on <a href="http://github.com/pkalogiros/audiomass" target="_blank">Github</a><br/><br/>'; // checkout the code on github
			}

			// Welcome to AudioMass,
			var md = new PKSimpleModal({
				title: '<font style="font-size:15px">欢迎使用鲁虺音频编辑器</font>',
			...
			body:'<div style="overflow:auto;-webkit-overflow-scrolling:touch;max-width:580px;width:calc(100vw - 40px);max-height:calc(100vh - 340px);min-height:110px;font-size:13px; color:#95c6c6;padding-top:7px;">'+
				'这是一款免费且功能强大的鲁虺在线音频/波形编辑器，直接在浏览器里打开即可使用，无需下载软件，无需安装插件！'+
				'<br/><br/><br/>'+
				body_str+
